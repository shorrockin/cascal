 ...
 * standard key
 */
case class StandardColumn[Owner](val name:Array[Byte],
                                 val value:Array[Byte],
                                 val time:Long,
                                 val owner:Owner) extends Column[StandardColumn[Owner]] {
   ...
   */
  def \(newValue:Array[Byte]) = new StandardColumn[Owner](name, newValue, time, owner)
