...
|_. Stable Version|1.0|
|_. Snapsot Version|1.1-SNAPSHOT|
|_. Scala Version|2.7.7|
|_. Cassandra Version|0.6.0-beta3|


h3. Description:

Cascal is a simple "Cassandra":http://cassandra.apache.org/ library built on the "Scala":www.scala-lang.org language that provides a very consistent and simple means by which you can interact with the Cassandra system.
